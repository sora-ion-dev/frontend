...
export const MODEL_BRANDS: AIBrand[] = [
    ...
    { id: "google/gemini-3.1-flash-live", brandId: "google/gemini-3.1-flash-live", name: "Gemini 3.1 Flash Live", brandName: "Gemini 3.1 Flash Live", brand: "Google", realBrandName: "Google", logo: "/logos/gemini_flash.svg", color: "#4285F4", description: "Ultra-low latency live multimodal intelligence", models: [{ id: "google/gemini-3.1-flash-live", name: "Gemini 3.1 Flash Live" }] },
