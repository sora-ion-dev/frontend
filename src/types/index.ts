...
export const MODEL_BRANDS: AIBrand[] = [
    ...
    { id: "nvidia/deepseek-4-flash", brandId: "nvidia/deepseek-4-flash", name: "DeepSeek 4 Flash", brandName: "DeepSeek 4 Flash", brand: "DeepSeek", realBrandName: "DeepSeek", logo: "/logos/deepseek_chat.svg", color: "#00E0FF", description: "Next-gen DeepSeek 4 Flash on Nvidia", models: [{ id: "nvidia/deepseek-4-flash", name: "DeepSeek 4 Flash" }] },
