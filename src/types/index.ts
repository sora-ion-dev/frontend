...
export const MODEL_BRANDS: AIBrand[] = [
    ...
    { id: "nvidia/deepseek-v32", brandId: "nvidia/deepseek-v32", name: "DeepSeek V3.2", brandName: "DeepSeek V3.2", brand: "DeepSeek", realBrandName: "DeepSeek", logo: "/logos/deepseek_chat.svg", color: "#00E0FF", description: "Elite efficiency with superior reasoning capabilities", models: [{ id: "nvidia/deepseek-v32", name: "DeepSeek V3.2" }] },
